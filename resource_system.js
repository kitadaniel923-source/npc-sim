...
(() => {
  ...
  const RESOURCES = {
    ...
    medicine:{name:'Medicine',category:'health',unit:'doses',base:22,description:'Prepared medical supplies.'},
    herbs:{name:'Herbs',category:'health',unit:'bundles',base:12,description:'Medicinal and culinary plants.'},
    reagents:{name:'Reagents',category:'arcane',unit:'bundles',base:28,description:'Rare ingredients used by alchemists and mages.'},
