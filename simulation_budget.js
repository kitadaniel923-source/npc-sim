...
(() => {
  ...
  const budget={tick:0,npcCursor:0,npcBatch:96,expensiveStride:1,settlementStride:1,relationshipStride:1,memoryStride:1,metrics:{npcProcessed:0,lastBatch:0,activeSystems:0}};
  ...
  function tune(){const p=population();budget.npcBatch=targetBatch();budget.expensiveStride=p>1000?3:p>400?2:1;budget.settlementStride=p>1500?3:p>700?2:1;budget.relationshipStride=p>1200?3:p>500?2:1;budget.memoryStride=p>1800?4:p>800?3:p>300?2:1;}
