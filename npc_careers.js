(() => {
  ...
  const CAREERS = [
    {id:'fisher', group:'food', fit:p=>p.discipline*.3+p.courage*.12+p.curiosity*.18+p.sociability*.12},
    {id:'mason', group:'industry', fit:p=>p.discipline*.45+p.cleverness*.22+p.courage*.1},
    {id:'potter', group:'craft', fit:p=>p.discipline*.3+p.cleverness*.28+p.sociability*.08},
    {id:'brewer', group:'food', fit:p=>p.sociability*.25+p.discipline*.28+p.kindness*.12},
    {id:'herbalist', group:'care', fit:p=>p.curiosity*.3+p.kindness*.3+p.discipline*.2},
    {id:'doctor', group:'care', fit:p=>p.cleverness*.35+p.kindness*.25+p.discipline*.25},
    {id:'peddler', group:'wealth', fit:p=>p.sociability*.35+p.risk*.2+p.cleverness*.12},
    {id:'innkeeper', group:'wealth', fit:p=>p.sociability*.35+p.kindness*.25+p.discipline*.15},
    {id:'shopkeeper', group:'wealth', fit:p=>p.sociability*.3+p.ambition*.2+p.discipline*.18},
    {id:'farrier', group:'animals', fit:p=>p.discipline*.35+p.courage*.18+p.kindness*.12},
    {id:'beastmaster', group:'animals', fit:p=>p.kindness*.25+p.courage*.2+p.discipline*.25},
    {id:'artist', group:'culture', fit:p=>p.curiosity*.3+p.sociability*.3+p.cleverness*.15},
    {id:'musician', group:'culture', fit:p=>p.sociability*.4+p.curiosity*.18+p.kindness*.12},
    {id:'courier', group:'civic', fit:p=>p.discipline*.35+p.sociability*.25+p.risk*.12},
    {id:'scribe', group:'civic', fit:p=>p.discipline*.35+p.cleverness*.35+p.curiosity*.15},
    {id:'lawkeeper', group:'civic', fit:p=>p.discipline*.35+p.loyalty*.3+p.courage*.15},
    {id:'tax_collector', group:'civic', fit:p=>p.discipline*.35+p.ambition*.2+p.cleverness*.2},
    {id:'judge', group:'civic', fit:p=>p.cleverness*.35+p.discipline*.25+p.loyalty*.18},
    {id:'librarian', group:'knowledge', fit:p=>p.curiosity*.4+p.cleverness*.35+p.discipline*.15},
    {id:'furniture_maker', group:'industry', fit:p=>p.cleverness*.3+p.discipline*.35},
